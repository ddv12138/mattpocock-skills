...
- **[setup-matt-pocock-skills](./setup-matt-pocock-skills/SKILL.md)** — Configure this repo for the engineering skills (output language, issue tracker, triage labels, domain doc layout). Run once per repo.
