...
**`/setup-matt-pocock-skills`** — run before your first engineering flow to configure the output language, issue tracker, triage labels, and doc layout the other skills assume. Custom issue trackers also work.
